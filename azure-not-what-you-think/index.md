...
Instead of explaining what services do, it explores:

*   Hidden defaults
*   Misconceptions that lead to design flaws
...
| Part | Focus | Link |
|------|------|------|
| **Part 1** | Networking Fundamentals: What Actually Happens | [Open](networking-fundamentals.md) |
